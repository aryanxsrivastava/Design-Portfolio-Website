...
const featuredDesigns: Design[] = [
  { id: 1, title: "Surreal Dreamscape", category: "Photo Manipulation", imageUrl: "https://placehold.co/800x600.png", imageWidth: 800, imageHeight: 600, aiHint: "surreal dreamscape" },
  { id: 2, title: "Vintage Movie Poster", category: "Graphic Design", imageUrl: "https://placehold.co/800x600.png", imageWidth: 800, imageHeight: 600, aiHint: "vintage poster" },
  { id: 3, title: "Fantasy Character", category: "Digital Painting", imageUrl: "https://placehold.co/800x600.png", imageWidth: 800, imageHeight: 600, aiHint: "fantasy character" },
  { id: 4, title: "Sci-Fi Concept Art", category: "Concept Art", imageUrl: "https://placehold.co/800x600.png", imageWidth: 800, imageHeight: 600, aiHint: "scifi concept" },
];
    ...
    >
      <div className="grid md:grid-cols-5 gap-8 items-start mb-16">
        ...
        <motion.div className="md:col-span-3" variants={itemVariants}>
          <p className="text-2xl md:text-3xl font-bold leading-tight">A curated selection of projects that break the mold and leave a lasting impression.</p>
        </motion.div>
      </div>
